...
<html lang="en">
  ...
  <?php
    ...
    $query = "SELECT CGName FROM ContactGroup";
    $contactGroups = mysqli_query($link,$query);

    if(!$contactGroups) {
    die("Invalid query: " . mysqli_error());
    }

    while($contactGroup = mysqli_fetch_array($contactGroups))
    {
      echo $contactGroup[0] . " ----contact group";
      echo "<br>";
      $services = mysqli_query($link, "SELECT FK_CGS_SName FROM ContactGroupService WHERE FK_CGS_CGName = '$contactGroup[0]'");
